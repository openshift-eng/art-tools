...
class TestPlashetBuilder(TestCase):
    ...
    def test_cache_build(self):
        ...
        self.assertEqual(
            set(builder._build_cache.keys()), {1, "bar-1.2.3-1.el8", 4, "foo-1.2.3-1.el8", "foo-1.2.3-1.el8:2"}
        )
    ...
    def test_from_images(self, list_archives_by_builds: Mock):
        ...
        list_archives_by_builds.return_value = [
            [
                {"rpms": [{"build_id": 101}, {"build_id": 102}, {"build_id": 103}]},
                {"rpms": [{"build_id": 102}, {"build_id": 104}]},
            ],
        ...
        self.assertEqual(
            {rpm_build["nvr"] for rpm_build in actual["fake-image1"]},
            {"fake101-1.2.3-1.el8", "fake102-1.2.3-1.el8", "fake103-1.2.3-1.el8", "fake104-1.2.3-1.el8"},
        )
        self.assertEqual(
            {rpm_build["nvr"] for rpm_build in actual["fake-image2"]}, {"fake201-1.2.3-1.el8", "fake202-1.2.3-1.el8"}
        )
    ...
    def test_from_image_member_deps(self, assembly_metadata_config: Mock):
        ...
        self.assertEqual(
            [b["nvr"] for b in actual.values()], ["fake1-1.2.3-1.el8", "fake2-1.2.3-1.el8", "fake3-1.2.3-1.el8"]
        )
