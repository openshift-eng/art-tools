...
def _build_mocks(
    ...
    Arg(s):
        ...
        release_notes_text: Value for Release Notes Text field on the created issue.
        release_notes_type: Value for Release Notes Type field on the created issue.
    ...
    setattr(mock_issue.fields, JIRABugTracker.field_release_notes_text, release_notes_text)
    setattr(mock_issue.fields, JIRABugTracker.field_release_notes_type, release_notes_type)
...
class TestReconcileJiraIssuesCustomFields(unittest.TestCase):
    ...
    def test_target_version_customfield_is_set(self, mock_connect):
        """
        Verify that Target Version field is updated
        ...
        self.assertIn(JIRABugTracker.field_target_version, updated_fields)
        self.assertEqual(updated_fields[JIRABugTracker.field_target_version], [{'name': '4.18.z'}])
    ...
    def test_release_notes_customfields_set_when_none(self, mock_connect):
        ...
        self.assertEqual(updated_fields[JIRABugTracker.field_release_notes_text], 'N/A')
        self.assertEqual(
            updated_fields[JIRABugTracker.field_release_notes_type], {'value': 'Release Note Not Required'}
        )
    ...
    def test_release_notes_customfields_not_set_when_already_populated(self, mock_connect):
        ...
        self.assertIn(JIRABugTracker.field_target_version, updated_fields)
        self.assertNotIn(JIRABugTracker.field_release_notes_text, updated_fields)
