            ...
            "logging-fluentd-container-v3.11.141-2": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "autorebuild": False,
                        "isolated": False,
                        "yum_repourls": ["http://pkgs.devel.redhat.com/cgit/containers/logging-fluentd/plain/.oit/signed.repo?h=rhaos-3.11-rhel-7"],
            ...
            "logging-fluentd-container-v4.1.14-201908291507": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "autorebuild": False,
                        "isolated": False,
                        "yum_repourls": ["http://pkgs.devel.redhat.com/cgit/containers/logging-fluentd/plain/.oit/signed.repo?h=rhaos-4.1-rhel-7"],
