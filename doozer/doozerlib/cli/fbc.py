...
# Add a new command: beta:fbc:merge for merging FBC fragments from multiple index images into a single index.
# Arguments: space separated list of index images and the destination index image.
...
class FbcRebaseCli:
    ...
    async def _get_operator_builds(self):
        ...
        # operator name to build records
        dgk_records: Dict[str, KonfluxBuildRecord] = {}
