...
@click.option(
    "-i", "--images", default=[], metavar='NAME', multiple=True,
...
@click.option(
    "-a", "--arches", default=[], metavar='ARCH', multiple=True,
...
@click.option(
    "--brew-event", metavar='EVENT', default=None, type=int,
    help="Lock koji clients from runtime to this brew event.",
)
@click.option(
    "--build-system", default='brew', envvar='BUILD_SYSTEM',
