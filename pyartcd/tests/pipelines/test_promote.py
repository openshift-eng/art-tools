...
class TestPromotePipeline(IsolatedAsyncioTestCase):
    ...
    async def test_promote_heterogeneous_payload(
        ...
        dest_manifest_list = {
            ...
            'manifests': [
                {'image': 'quay.io/openshift-release-dev/ocp-release:4.10.99-multi-x86_64', 'platform': {'os': 'linux', 'architecture': 'amd64'}},
                {'image': 'quay.io/openshift-release-dev/ocp-release:4.10.99-multi-aarch64', 'platform': {'os': 'linux', 'architecture': 'arm64'}},
            ],
        }
