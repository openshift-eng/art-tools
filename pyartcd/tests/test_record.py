...
class TestRecordUtils(TestCase):
    def setUp(self):
        log = StringIO(
            """source_alias|alias=containers_ose-haproxy-router-base_router|origin_url=https://github.com/openshift-priv/router|branch=release-4.12|path=/workspace/containers_ose-haproxy-router-base_router|
