...
from artcommonlib.util import get_inflight, isolate_major_minor_in_group, merge_objects, new_roundtrip_yaml_handler, split_git_url
...
class GenAssemblyPipeline:
    ...
    def __init__(
        ...
        self._doozer_env_vars["DOOZER_DATA_PATH"] = data_path if data_path else self.runtime.config.get("build_config", {}).get("ocp_build_data_url")
