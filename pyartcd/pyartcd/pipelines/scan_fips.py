...
class ScanFips:
    ...
    @staticmethod
    def construct_failing_packages_report(failing_packages: dict[str, set[str]], package_ticket_details: dict[str, tuple[str, set[str]]]) -> str:
        """
    ...
    @staticmethod
    def construct_packages_without_ticket_report(failing_packages: dict[str, set[str]], package_ticket_details: dict[str, tuple[str, set[str]]]) -> str:
        """
    ...
    async def message_on_slack(self, failing_packages: dict[str, set[str]]):
        ...
        packages_without_ticket_report_msg = self.construct_packages_without_ticket_report(failing_packages, package_ticket_details)
