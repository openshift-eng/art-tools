...
class TestResolveKonfluxFbcStageReleasePlan(unittest.TestCase):
    def test_layered_product_versions_return_exact_names(self):
        expected_plans = {
            ...
            ("ocp", 4, 12): "ocp-art-advisory-stage-auto-4-12",
            ("ocp", 4, 13): "ocp-art-advisory-stage-auto-4-13",
            ("ocp", 4, 14): "ocp-art-advisory-stage-auto-4-14",
            ("ocp", 4, 15): "ocp-art-advisory-stage-auto-4-15",
            ("ocp", 4, 16): "ocp-art-advisory-stage-auto-4-16",
            ("ocp", 4, 17): "ocp-art-advisory-stage-auto-4-17",
            ("ocp", 4, 18): "ocp-art-advisory-stage-auto-4-18",
            ("ocp", 4, 19): "ocp-art-advisory-stage-auto-4-19",
            ("ocp", 4, 20): "ocp-art-advisory-stage-auto-4-20",
            ("ocp", 4, 21): "ocp-art-advisory-stage-auto-4-21",
            ("ocp", 4, 22): "ocp-art-advisory-stage-auto-4-22",
            ("ocp", 4, 23): "ocp-art-advisory-stage-auto-4-23",
            ("ocp", 5, 0): "ocp-art-advisory-stage-auto-5-0",
