...
RHCOS_RELEASES_BASE_URL = "https://releases-rhcos--prod-pipeline.apps.int.prod-stable-spoke1-dc-iad2.itup.redhat.com/storage/releases"
RHCOS_RELEASES_STREAM_URL = "https://releases-rhcos--prod-pipeline.apps.int.prod-stable-spoke1-dc-iad2.itup.redhat.com/storage/prod/streams"
...
SHIPMENT_DATA_URL = "https://gitlab.cee.redhat.com/hybrid-platforms/art/{}-shipment-data"
