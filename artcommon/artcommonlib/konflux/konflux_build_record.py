...
class KonfluxRecord:
    ...
    def __init__(
        self, name: str = '', group: str = '', version: str = '', release: str = '', assembly: str = '',
    ...
    def to_dict(self) -> dict:
        ...
        return {
            key: (
                value.strftime("%Y-%m-%dT%H:%M:%S") if isinstance(value, datetime)
...
class KonfluxBuildRecord(KonfluxRecord):
    ...
    def __init__(
        ...
        super().__init__(
            name, group, version, release, assembly, source_repo, commitish, rebase_repo_url,
...
class KonfluxFbcBuildRecord(KonfluxRecord):
    ...
    def __init__(
        self, name: str = '', group: Optional[str] = '', version: str = '', release: str = '', assembly: Union[str, None] = '',
        source_repo: str = '', commitish: str = '', rebase_repo_url: str = '', rebase_commitish: str = '',
