...
from elliottlib.shipment_model import Issue, Issues, ReleaseNotes
...
class TestRPMAdvisoryUpdate(unittest.TestCase):
    ...
    def test_brew_flow_updates_rpm_advisory(self, mock_boilerplate, mock_live_id):
        ...
        advisory = Mock(errata_type="RHBA", cve_names="", security_impact="Low", topic="Bug fixes", update=Mock())
    ...
    def test_konflux_flow_updates_rpm_advisory(self, mock_boilerplate, mock_live_id, mock_get_konflux_component):
        ...
        flaw_bugs = [BugzillaBug(Mock(id=1, alias=['CVE-2024-1'], summary='CVE-2024-1 test', severity='important'))]
        tracker_bugs = [BugzillaBug(Mock(id=1, whiteboard='component: test'))]
        tracker_flaws = {1: [1]}

        # Call the method
        pipeline.update_release_notes(
            release_notes, flaw_bugs, tracker_bugs, tracker_flaws, attached_components={'test-konflux-component'}
        )
