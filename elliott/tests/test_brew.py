...
class TestBrew(unittest.TestCase):
    ...
    def test_get_brew_build_success(self, MockSession, _):
        ...
        mock_session.get.assert_called_once_with(
            constants.errata_get_build_url.format(id=nvr), verify="/my/cert.pem", auth=mock.ANY
        )
            ...
            "logging-fluentd-container-v3.11.141-2": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "isolated": False,
                        "yum_repourls": [
                            "https://pkgs.devel.redhat.com/cgit/containers/logging-fluentd/plain/.oit/signed.repo?h=rhaos-3.11-rhel-7"
                        ],
                        ...
                        "parent_image_builds": {
                            "openshift/ose-base:rhel7": {
                                "id": 955726,
                                "nvr": "openshift-enterprise-base-container-v4.0-201908250221",
                            }
                        },
                    },
                ...
                "build_id": 956245,
                "epoch": None,
                "source": "git://pkgs.devel.redhat.com/containers/logging-fluentd#7f4bcdc798fd72414a29dc1010c448e1ed52f591",
                "state": 1,
                "version": "v3.11.141",
            ...
            "logging-fluentd-container-v4.1.14-201908291507": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "help": None,
                        "index": {
                            "unique_tags": ["rhaos-4.1-rhel-7-containers-candidate-94076-20190829211225"],
                            "pull": [
                        ...
                        "isolated": False,
                        "yum_repourls": [
                            "https://pkgs.devel.redhat.com/cgit/containers/logging-fluentd/plain/.oit/signed.repo?h=rhaos-4.1-rhel-7"
                        ],
                        "parent_build_id": 958278,
                        "parent_images": ["rhscl/ruby-25-rhel7:latest", "openshift/ose-base:ubi7"],
                        "parent_image_builds": {
                            "openshift/ose-base:ubi7": {
                                "id": 958278,
                                "nvr": "openshift-enterprise-base-container-v4.0-201908290538",
                            },
                            "rhscl/ruby-25-rhel7:latest": {"id": 957642, "nvr": "rh-ruby25-container-2.5-50"},
                        },
                    },
                ...
                "build_id": 958765,
                "epoch": None,
                "source": "git://pkgs.devel.redhat.com/containers/logging-fluentd#ecac10b38f035ea2f9ea62b9efa63c051667ebbb",
                "state": 1,
                "version": "v4.1.14",
            ...
            "logging-fluentd-container-v4.1.15-201909041605": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "help": None,
                        "index": {
                            "unique_tags": ["rhaos-4.1-rhel-7-containers-candidate-96970-20190904214308"],
                            "pull": [
                        ...
                        "parent_build_id": 961131,
                        "parent_images": ["rhscl/ruby-25-rhel7:latest", "openshift/ose-base:ubi7"],
                        "parent_image_builds": {
                            "openshift/ose-base:ubi7": {
                                "id": 961131,
                                "nvr": "openshift-enterprise-base-container-v4.0-201909040323",
                            },
                            "rhscl/ruby-25-rhel7:latest": {"id": 957642, "nvr": "rh-ruby25-container-2.5-50"},
                        },
                    },
                ...
                "build_id": 962144,
                "epoch": None,
                "source": "git://pkgs.devel.redhat.com/containers/logging-fluentd#31cf3d4264dabb8892fb4b5921e5ff4d5d0ab2de",
                "state": 1,
                "version": "v4.1.15",
