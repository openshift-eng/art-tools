            ...
            "logging-fluentd-container-v3.11.141-2": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "autorebuild": False,
                        "isolated": False,
                        "yum_repourls": ["https://pkgs.devel.redhat.com/cgit/containers/logging-fluentd/plain/.oit/signed.repo?h=rhaos-3.11-rhel-7"],
            ...
            "logging-fluentd-container-v4.1.14-201908291507": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "autorebuild": False,
                        "isolated": False,
                        "yum_repourls": ["https://pkgs.devel.redhat.com/cgit/containers/logging-fluentd/plain/.oit/signed.repo?h=rhaos-4.1-rhel-7"],
                        "parent_build_id": 958278,
                        "parent_images": ["rhscl/ruby-25-rhel7:latest", "openshift/ose-base:ubi7"],
                        "parent_image_builds": {
                            "openshift/ose-base:ubi7": {"id": 958278, "nvr": "openshift-enterprise-base-container-v4.0-201908290538"},
            ...
            "logging-fluentd-container-v4.1.15-201909041605": {
                ...
                "extra": {
                    ...
                    "image": {
                        ...
                        "parent_images": ["rhscl/ruby-25-rhel7:latest", "openshift/ose-base:ubi7"],
                        "parent_image_builds": {
                            "openshift/ose-base:ubi7": {"id": 961131, "nvr": "openshift-enterprise-base-container-v4.0-201909040323"},
                            "rhscl/ruby-25-rhel7:latest": {"id": 957642, "nvr": "rh-ruby25-container-2.5-50"},
                        },
                    },
